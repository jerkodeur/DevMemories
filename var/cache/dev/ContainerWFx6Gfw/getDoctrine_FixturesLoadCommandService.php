...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ColorFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ContentFixtures.php';
        ...
        $c = ($container->privates['App\\Repository\\CategoryRepository'] ?? $container->load('getCategoryRepositoryService'));

        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\CategoryFixtures($b, ($container->privates['App\\Repository\\ColorRepository'] ?? $container->load('getColorRepositoryService')), $c), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ColorFixtures($b), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ContentFixtures($b, $c, ($container->privates['App\\Repository\\TypeRepository'] ?? $container->load('getTypeRepositoryService'))), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\TypeFixtures(($container->services['doctrine.orm.default_entity_manager'] ?? $container->getDoctrine_Orm_DefaultEntityManagerService())), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\UserFixtures(($container->privates['security.user_password_hasher'] ?? $container->load('getSecurity_UserPasswordHasherService'))), 'groups' => []]]);
