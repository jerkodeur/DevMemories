...
class getWebpackEncore_EntrypointLookupDefaultService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['webpack_encore.entrypoint_lookup[_default]'] = new \Symfony\WebpackEncoreBundle\Asset\EntrypointLookup((\dirname(__DIR__, 4).'/public/build/entrypoints.json'), \Symfony\Component\Cache\Adapter\PhpArrayAdapter::create(($container->targetDir.''.'/webpack_encore.cache.php'), ($container->privates['cache.webpack_encore'] ?? $container->getCache_WebpackEncoreService())), '_default', true);
    }
}
